...
class InceptionScore(torch.nn.Module):
    """ Manages and returns the inception score of images."""
    ...
    def forward(self, image_batch):
        """ 
        Image batch should of dimensions BCHW and should be normalized.
        """
        ...
        prob_yx = torch.nn.functional.softmax(torch.cat(scores, dim=0), dim=1)
