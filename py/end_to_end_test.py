...
# from federated_learning.intOperators import FullyConnected, ConvolutionOperator, AvgPoolOperator
# from federated_learning.utils import extract_uint_weight, dump_txt
# from federated_learning.data_utils import load_cifar10, load_mnist
...
worker = Worker(0, X_train[0], Y_train[0], X_test, Y_test, model=LeNet_MNIST())
...
dump_path = "pretrained_model\LeNet_MINIST/"
worker.quantized_model_forward(X_test[:100], Y_test[:100], dump_flag=True, dump_path=dump_path)
